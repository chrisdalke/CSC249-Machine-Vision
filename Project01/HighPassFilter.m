...
function resultImage = HighPassFilter(inputImage, imageName)
    ...
    imwrite(uint8(resultImage),['Outputs/filters/' imageName '_highpass.png']);
    freqz2(highPassFilter,[32 32]); axis tight;
    saveas(gcf,'Outputs/freq/highpass_freq.png');
